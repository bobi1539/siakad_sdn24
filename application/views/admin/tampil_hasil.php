                            ...
                            <?php foreach ($hasil as $data) : ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="<?php echo base_url('admin/download_file_hasil/') . $data['dokumen'] ?>" class="btn btn-sm btn-primary">Download</a>
                                    </td>
                                    <td class="text-center">
                                        <a href="<?php echo base_url('admin/hapus_hasil/') . $data['no_pengajuan'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Yakin data dihapus?')">Hapus</a>
                                    </td>
                                </tr>
                            <?php endforeach ?>
                        </tbody>
